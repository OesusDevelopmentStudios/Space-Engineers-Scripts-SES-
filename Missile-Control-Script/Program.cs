...
namespace IngameScript {
    partial class Program : MyGridProgram {
        ...
        void InitShip() {
            ...
            if (refCon != null && refCon.Status == MyShipConnectorStatus.Connected) { if (!Me.CustomName.StartsWith("MISSILE-")) { Me.CustomName = getCustName(); } }

            if (CameraList.Count < MIN_SUCC_CAMERAS || refCon == null) return;
